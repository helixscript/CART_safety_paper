...
createIntUCSCTrack(ag, title = paste0('sites <= ', config$earlyVsLateCutoffDays, ' days'), outputFile = 'early.ucscTrack', siteLabel = 'siteLabel')
...
createIntUCSCTrack(bg, title = paste0('sites > ', config$earlyVsLateCutoffDays, ' days'), outputFile = 'late.ucscTrack', siteLabel = 'siteLabel')
...
system('cat early.ucscTrack late.ucscTrack > tracks.ucsc')
invisible(file.remove(c('early.ucscTrack', 'late.ucscTrack')))
...
ggsave('pValAdjVolcanotPlot.pdf', pValAdjVolcanoPlot, units = 'in', width = 10, height = 15)
...
ggsave('pValRawVolcanotPlot.pdf', pValVolcanoPlot, units = 'in', width = 10, height = 12)
